...
@property (nonatomic, strong) NSMutableDictionary* stacktrace;
...
@property (nonatomic, strong) NSArray<Optional>* breadcrumbs;

@property (nonatomic, strong) NSString<Optional>* log;

@property (nonatomic, strong) NSString<Optional>* threadCrashed;
...
@property (nonatomic, strong) NSString<Optional>* imageSize;

@property (nonatomic, strong) NSString<Optional>* crashReport;
@property (nonatomic, strong) NSString<Optional>* slide;
@property (nonatomic, strong) NSString<Optional>* loadAddress;
